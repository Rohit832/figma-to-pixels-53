...
export const PlatformSection: React.FC = () => {
  ...
  return <section className="container mx-auto w-full h-auto my-0 p-5 md:p-6 flex flex-col lg:flex-row items-start lg:items-start justify-start lg:justify-between gap-8">
      <div className="flex items-start gap-[5px] relative w-full lg:w-[327px] lg:max-w-[500px] mx-auto lg:mx-0">
        <ProgressIndicator />
        
        <div className="flex w-full lg:w-[271px] flex-col items-start lg:items-start gap-[45px] shrink-0 relative">
          <header className="w-full text-black text-[19px] font-normal tracking-[1.344px] relative max-sm:text-base text-left lg:text-left">
            One platform multiple touchpoints
          </header>
          
          <div className="flex flex-col items-start lg:items-start gap-[38px] self-stretch relative lg:pl-10 max-sm:gap-[25px] max-sm:pl-5">
            ...
            <div className="flex flex-col items-start lg:items-start gap-5 self-stretch relative">
